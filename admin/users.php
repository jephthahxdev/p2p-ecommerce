                        ...
                        <div class="tt-btn-img-list">
                            <div class="row">
                                <div class="container-custom">
                                    <h2 class="tt-title">USERS</h2>
                                </div>                                    
                                    <table class="container-custom tt-table-shop-01">                                       
                                        <thead>
                                            <tr>
                                                <th class="c-title-small">User ID</th>
                                                <th class="c-title-small">User</th>
                                                <th class="c-title-small">Email</th>
                                                <th class="c-title-small">Phone</th>
                                                <th class="c-title-small">Earnings</th>
                                ...
                                <script>
                                    function loadUsers(page) {
                                        ...
                                        xhttp.open("GET", "../dbase/get_users.php?page=" + page, true);
                                        xhttp.send();
                                    }
                                    ...
                                    function nextPage() {
                                        loadUsers(<?php echo $currentPage; ?> + 1);
                                    }

                                    // Load the initial page
                                    loadUsers(<?php echo $currentPage; ?>);
                                    ...
                                    function deleteUser(userId) {
                                        if (confirm("Are you sure you want to delete this user?")) {
                                            ...
                                            xhttp.open("GET", "../dbase/delete_user.php?user_id=" + userId, true);
                                            xhttp.send();
                                        }
                                    }
                                </script>
