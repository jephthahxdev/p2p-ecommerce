...
<head>
	<meta charset="utf-8">
	<title>MarionPeer | Products</title>
                            ...
                            <div class="row">
                                <div class="container-custom">
                                    ...
                                    <table class="container-custom tt-table-shop-01">                                       
                                        ...
                                        <tbody id="productTable" class="c-title-small">
                                ...
                                <script>
                                    function loadProducts(page) {
                                        ...
                                        xhttp.open("GET", "../dbase/get_products_all.php?page=" + page, true);
                                        xhttp.send();
                                    }
                                    ...
                                    function deleteProduct(productId) {
										if (confirm("Are you sure you want to delete this product?")) {
											...
											xhttp.open("GET", "../dbase/delete_product.php?product_id=" + productId, true);
											xhttp.send();
										}										
                                    }                                  
                                </script>
