								...
								<div class="tt-dropdown-menu">
									...
									<div class="tt-dropdown-inner">
										<ul>
											...
											<li><a href="register.php"><i class="icon-f-77"></i>Register</a></li>
										</ul>
									</div>
								</div>
							</div>
...
<div id="tt-pageContent">
	<div class="container-indent">
		<div class="container">
			<h1 class="tt-title-subpages noborder">WELCOME BACK</h1>
					...
					<div class="col-xs-12 col-md-6">
						<div class="tt-item">
							...
							<div class="form-group">
								<a href="register.php" class="btn btn-top btn-border">CREATE AN ACCOUNT</a>
							</div>
						</div>
					</div>
					<div class="col-xs-12 col-md-6">
						<div class="tt-item">
							...
							<div class="form-default form-top">
								<form method="post" action="dbase/signin.php" id="loginForm">
									<?php session_start();
