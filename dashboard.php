...
$sqlTotalEarnings = "SELECT SUM(paid_amount) as earnings FROM orders WHERE vendor = '$user_name'";
$result = $conn->query($sqlTotalEarnings);
...
$sqlTotalPurchases = "SELECT COUNT(*) as total_purchases FROM transactions WHERE user_id = '$user_id'";
$result = $conn->query($sqlTotalPurchases);
...
$sqlTotalOrders = "SELECT COUNT(*) as total_orders FROM orders WHERE vendor = '$user_name'";
...
// Query to get the count of unopened messages for the user
$sqlTotalUnopened = "SELECT COUNT(*) AS unopened_messages FROM messages WHERE userId = '$user_id' AND is_opened = 0";
$result = $conn->query($sqlTotalUnopened);

if ($result && $result->num_rows > 0) {
	$row = $result->fetch_assoc();
	$unopenedMessages = $row['unopened_messages'];
} else {
	$unopenedMessages = 0;
}
	...
	<div class="tt-offset-20 container-indent">
		<div class="container">
			<div class="row">
						...
						<div class="tt-dropdown-menu" style="display: block;">
							<nav>
								<ul>
									...
									<li class="tt-submenu">
										<a href="mailto:marion.onwuneme22@gmail.com" target="_blank">
				...
				<div class="col-12 col-md-10 col-lg-9"> <!-- Col 9; Other columns fit into-->
					...
					<div class="container-custom">
						<div class="tt-btn-img-list">
							<div class="row">
								<div class="col-6 col-sm-4 col-6-inrow-lg">
									<div href="#" class="fun-fact-box">
										<div class="fun-content">
											<div class="c-title-small">Total Purchases</div>
											<div class="c-title-large"><?php echo $totalPurchases; ?></div>
										</div>
										<div class="icon">
											<div class="icon-box">
												<img src="images/custom/shopping.png" alt="purchases">
											</div>
										</div>
									</div>
								</div>
								<div class="col-6 col-sm-4 col-6-inrow-lg">
									<div href="#" class="fun-fact-box">
										<div class="fun-content">
											<div class="c-title-small">Total Orders</div>
											<div class="c-title-large"><?php echo $totalOrders; ?></div>
										</div>
										<div class="icon">
											<div class="icon-box">
												<img src="images/custom/online-shopping.png" alt="orders">
											</div>
										</div>
									</div>
								</div>
								<div class="col-6 col-sm-4 col-6-inrow-lg">
									<div href="#" class="fun-fact-box">
										<div class="fun-content">
											<div class="c-title-small">Messages</div>
											<div class="c-title-large"><?php echo $unopenedMessages; ?></div>
										</div>
										<div class="icon">
											<div class="icon-box">
												<img src="images/custom/message.png" alt="messages">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-12">
										<div href="#" class="fun-fact-box">
											<div class="col-9">
												<div class="fun-content">
													<div class="c-title-large">Hello, <?php echo $user_name; ?></div>
													<div class="c-title-small" style="text-transform:none"><?php echo $user_email; ?></div>
												</div>
											</div>
											<div class="col-3">
													<div class="balance-content c-title-large"><span>&#163;&nbsp;</span><?php echo $totalEarnings; ?></div>
													<div class="row">
														<span class="balance-content c-title-small"><img src="images/custom/wallet.png" alt="balance" width="22px" height="20px" style="padding-right: 5px;">EARNINGS</span>			
													</div>
											</div>
										</div>
									</div>
	...
	<div class="container-custom">
		<div class="container">
			<div class="tt-btn-img-list">
				<div class="row">
					<div class="container-custom">
						<h2 class="tt-title">RECENT ORDER & PURCHASE TRANSACTIONS</h2>
					</div>
						<table class="container-custom tt-table-shop-01">
							<thead>
								<tr>
									<th class="c-title-small">Transaction ID</th>
									<th class="c-title-small">Transaction Type</th>
						...
						<script>
							function loadProducts(page) {
								...
								xhttp.open("GET", "dbase/get_transactions.php?page=" + page, true);
								xhttp.send();
							}
