...
<head>
	<meta charset="utf-8">
	<title>MarionPeer | Register</title>
...
<div id="tt-pageContent">
	<div class="container-indent">
		<div class="container">
			<h1 class="tt-title-subpages noborder">DO NOT HAVE AN ACCOUNT?</h1>
			<div class="tt-login-form">
				<div class="row">
					<div class="col-xs-12 col-md-6">
						<div class="tt-item">
							<h2 class="tt-title">RETURNING CUSTOMER</h2>
							<p>
								Are you a returning user? Proceed to login and continue your in-store experience with Marion Peer.
							</p>
							<div class="form-group">
								<a href="login.php" class="btn btn-top btn-border">LOGIN TO EXISTING ACCOUNT</a>
							</div>
						</div>
					</div>
					<div class="col-xs-12 col-md-6">
						<div class="tt-item">
							...
							<div class="form-default form-top">
								<form method="post" action="dbase/signup.php" id="loginForm">
									<?php
