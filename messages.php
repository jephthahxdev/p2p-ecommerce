                        ...
                        <div class="tt-btn-img-list">
                            <div class="row">
                                <div class="container-custom">
                                    <h2 class="tt-title">MESSAGE NOTIFICATIONS</h2>
                                </div>
                                    <table class="container-custom tt-table-shop-01">
                                        <thead>
                                            <tr>
                                                <th class="c-title-small">Sender</th>
                                                <th class="c-title-small">Product Name</th>
                                                <th class="c-title-small">Message</th>
                                ...
                                <script>
                                    function loadMessages(page) {
                                        ...
                                        xhttp.open("GET", "dbase/get_messages.php?page=" + page, true);
                                        xhttp.send();
                                    }
                                    ...
                                    function nextPage() {
                                        loadMessages(<?php echo $currentPage; ?> + 1);
                                    }

                                    // Load the initial page
                                    loadMessages(<?php echo $currentPage; ?>);
