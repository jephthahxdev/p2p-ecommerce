...
<head>
	<meta charset="utf-8">
	<title>MarionPeer | Purchases</title>
						...
						<div class="tt-dropdown-menu" style="display: block;">
							<nav>
								<ul>
									...
									<li class="tt-submenu">
										<a href="mailto:marion.onwuneme22@gmail.com">
                        ...
                        <div class="tt-btn-img-list">
                            <div class="row">
                                <div class="container-custom">
                                    <h2 class="tt-title">RECENTLY PURCHASED PRODUCTS</h2>
                                </div>
                                    <table class="container-custom tt-table-shop-01">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="c-title-small">Paid</th>
                                ...
                                <script>
                                    function loadProducts(page) {
                                        ...
                                        xhttp.open("GET", "dbase/get_purchases.php?page=" + page, true);
                                        xhttp.send();
                                    }
